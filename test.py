...
mat = scipy.io.loadmat('mgh_voxel_graph.mat')

mm2csr(mat)

boo = csr_matrix(mm2csr(mat), dtype=np.int8).toarray()
...
distances, predecessors = dijkstra(boo, indices=0, return_predecessors=True, directed=True)
